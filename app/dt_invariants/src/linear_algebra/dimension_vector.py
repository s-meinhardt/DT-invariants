...
class DimensionVector(Immutable, Sequence):
    ...
    For dividing dimension vectors, you have 2 options:

    1. Dividing through an integer performs a floor division
       of the coordinates.

       >>> d / 2
       (0,1)

    2. Floor division by another dimension vector which depends
       on the choice of a 'positive' :class:`cone`.
    ...
    can be compared.
    Another partial order will be introduced in the context of a
    :class:`cone`.
